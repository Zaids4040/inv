       ...
       <?php $sells_list = sel_table("home_sells",""); ?>
			...
			?>
                ...
                <div class="input-field">
                	...
                	<input type="text" onKeyUp="discount()" name="discounttxt" id="discounttxt" />
    ...
    <div class="main-panel">
      ...
      <div class="content">
      	<div class="container-flude">
            ...
            <?php
			$products_data = sel_table("products","");
            ...
            ?>
               ...
               <form id="productaddform">
                    <div class="card">
                        ...
                        <input type="button" onClick="productadd(<?php echo $products[0]; ?>,'<?php echo $products[1]; ?>',<?php echo $products[2]; ?>,'singlebtn')" name="singlebtn" id="singlebtn" style="height:150px;width:100%;background-position: center;background-repeat: no-repeat; background-size: contain;border: none; background-image:url(<?php echo $products[11]; ?>);">
